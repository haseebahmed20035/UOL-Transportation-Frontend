...
const AdminDashboard = ({ navigation }) => {
  ...
  <View style={[styles.card, { backgroundColor: theme.colors.background }]}>
    ...
    <View style={styles.row}>
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('ManageBuses')}>
      ...
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('ManageRoutes')}>
      ...
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('AssignRoutes')}>
        <Icon name="git-branch-outline" size={26} color={theme.colors.icon} />
        <Text style={[styles.boxText, { color: theme.colors.text }]}>
          Assign Routes
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('BusSchedule')}>
  ...
  <View style={[styles.card, { backgroundColor: theme.colors.background }]}>
    ...
    <View style={styles.row}>
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('AllLiveTracking')}>
        <Icon name="locate-outline" size={26} color={theme.colors.icon} />
        <Text style={[styles.boxText, { color: theme.colors.text }]}>
          Live Tracking
        </Text>
      </TouchableOpacity>
  ...
  <View style={[styles.card, { backgroundColor: theme.colors.background }]}>
    ...
    <View style={styles.row}>
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('StudentManage')}>
        <Icon name="people-outline" size={26} color={theme.colors.icon} />
        <Text style={[styles.boxText, { color: theme.colors.text }]}>
          Students
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('DriverManage')}>
      ...
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('RequestsManage')}>
        <Icon name="clipboard-outline" size={26} color={theme.colors.icon} />
        <Text style={[styles.boxText, { color: theme.colors.text }]}>
          Requests
        </Text>
      </TouchableOpacity>
  ...
  <View style={[styles.card, { backgroundColor: theme.colors.background }]}>
    ...
    <View style={styles.row}>
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        onPress={() => navigateAndTrack('SendNotification')}>
        <Icon name="notifications-outline" size={26} color={theme.colors.icon} />
        <Text style={[styles.boxText, { color: theme.colors.text }]}>
          Send Notification
        </Text>
      </TouchableOpacity>
  ...
  <View style={[styles.card, { backgroundColor: theme.colors.background }]}>
    ...
    <View style={styles.row}>
      ...
      <TouchableOpacity style={[styles.box, { backgroundColor: theme.colors.box, borderColor: theme.colors.border }]}
        ...
        <Icon name="help-circle-outline" size={26} color={theme.colors.icon} />
        <Text style={[styles.boxText, { color: theme.colors.text }]}>
          Help
        </Text>
      </TouchableOpacity>
