...
const DriverNotification = ({ navigation }) => {
  ...
  const loadUserAndNotifications = async () => {
    try {
      ...
      setUserId(driverNotificationUserId)

      await fetchNotifications(driverNotificationUserId)
    } catch (error) {
      console.log('Load driver notifications error:', error)
    } finally {
      setLoading(false)
    }
  }
  ...
  const fetchNotifications = async id => {
    try {
      ...
      console.log(
        'Fetch driver notifications error:',
  ...
  const markAsRead = async item => {
    try {
      ...
      console.log(
        'Mark driver notification read error:',
        error?.response?.data || error,
      )
    }
  }
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              console.log(
                'Clear driver notifications error:',
                error?.response?.data || error,
              )
